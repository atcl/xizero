...
class CLgfx1
{
	...
	public:
		...
		void drawpixeldirect(xlong x,xlong y,uxlong c);
		...
		void drawhorline(xlong x1,xlong y1,uxlong l,uxlong c);
		void drawhorline(xlong x1,xlong y1,xlong x2,uxlong c);
		void drawverline(xlong x1,xlong y1,uxlong l,uxlong c);
		void drawverline(xlong x1,xlong y1,xlong y2,uxlong c);
		void drawdialine(xlong x1,xlong y1,uxlong l,uxlong c);
		...
		void fillframe(xlong x,xlong y,uxlong c);
