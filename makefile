...
O0FLAGS = -O0
O2FLAGS = -O2
OPT     = -ffast-math -fomit-frame-pointer -funroll-loops -floop-optimize -funit-at-a-time -fsingle-precision-constant
LDFLAGS = -lX11
OUTPARA = -o 
DEBUG   = -g
LINUX   = -DLINUX
...
# Compile:
default:
	$(CC) $(O2FLAGS) $(OPT) $(OUTPARA) $(TARGET1) $(SOURCE1) $(LDFLAGS) $(WWFLAGS) $(LINUX) $(DEVELOP) $(X86) $(DEBUG) #change to RELEASE
	#$(STRIP) $(TARGET1)
	$(XZDAT) #activate
